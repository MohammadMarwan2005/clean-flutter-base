...
class _Success implements TestState {
  const _Success(this.response);
  

 final  SuccessAuthData response;
...
@override
String toString() {
  return 'TestState.success(response: $response)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $TestStateCopyWith<$Res> {
  factory _$SuccessCopyWith(_Success value, $Res Function(_Success) _then) = __$SuccessCopyWithImpl;
@useResult
$Res call({
 SuccessAuthData response
});
...
class _Error implements TestState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $TestStateCopyWith<$Res> {
